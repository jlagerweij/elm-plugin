...
import static org.elmlang.intellijplugin.utils.PsiFiles.isPsiFileInProject;

public class ElmLanguageFileDocumentManager extends FileDocumentManagerAdapter {
    @Override
    ...
    private void processPsiFile(Project project, PsiFile psiFile) {
        if (psiFile.getLanguage().equals(ElmLanguage.INSTANCE)) {
